...
<html>
	...
	<head>
		...
		<title>Testando video em HTML</title>
	...
	<body>
		...
		<div class="container">
        		...
        		<div class="row">
            		...
            		<div class="col-md-8">
                			<iframe width="750" height="500" src="http://www.youtube.com/embed/UwlPVpBfk_I"></iframe>
           			</div>

            		<div class="col-md-4">
            			<form name="form1" method="post" action="signup.php">
	            			<div class="login-area">
	           					<div id="login"><h3>Cadastro</h3></span></a> <br>
	       							<input name="myusername" type="text" id="myusername" placeholder="Digite seu email"> <br> <br>
	       							<input name="mypassword" id="mypassword" type="password" placeholder="Digite sua senha">
